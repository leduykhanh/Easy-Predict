...
import jangkoo.predict.utils.ChucTetListViewAdapter;

public class QuotesFragment extends Fragment {
    DownloadTask downloadTask ;
    TextView content;
    View rootView;
    private ChucTetListViewAdapter adapter;
    private ArrayList<HashMap<String,String>> arrayList;
    private TextView totalTv;
    private ListView chuctetList;
    Context ctx;
    //image
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        chuctetList = (ListView) rootView.findViewById(R.id.content_list);
        adapter =  new ChucTetListViewAdapter(this.getActivity(), arrayList);
        chuctetList.setAdapter(adapter);
